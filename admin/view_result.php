...
<div class="container-fluid" id="printable">
	<table width="100%">
		<tr>
			<td width="50%">Mã sinh viên: <b><?php echo $student_code ?></b></td>
			<td width="50%">Lớp học: <b><?php echo $class ?></b></td>
		</tr>
		<tr>
			<td width="50%">Họ tên sinh viên: <b><?php echo ucwords($name) ?></b></td>
			<td width="50%">Giới tính: <b><?php echo ucwords($gender) ?></b></td>
		</tr>
	</table>
	<hr>
	<table class="table table-bordered">
		...
		<tbody>
    		...
    		<tr>
    			...
    			<td class="text-center"><?php echo number_format($row['mark'], 1) ?></td>
    		</tr>
			<?php endwhile; ?>
		</tbody>
		<tfoot>
			<tr>
				<th colspan="2" class="text-center">Điểm trung bình tổng các môn</th>
				<th class="text-center"><?php  echo number_format($marks_percentage,1) ?></th>
			</tr>
		</tfoot>
	</table>
</div>
<div class="modal-footer display p-0 m-0">
        <button type="button" class="btn btn-success" id="print"><i class="fa fa-print"></i> In</button>
...
<noscript>
	...
	<h3 class="text-center"><b>In kết quả sinh viên</b></h3>
</noscript>
<script>
