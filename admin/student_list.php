	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary " href="./index.php?page=new_student"><i class="fa fa-plus"></i> Thêm mới</a>
			</div>
		</div>
		<div class="card-body">
...
<script>
	$(document).ready(function() {
		...
		$('.delete_student').click(function() {
			_conf("Bạn muốn xóa sinh viên này?", "delete_student", [$(this).attr('data-id')])
		})
	})
