...
<div class="container-fluid">
	<form action="" id="manage-subject">
		...
		<div class="form-group">
			<label for="code" class="control-label">Mã môn học</label>
		...
		<div class="form-group">
			<label for="subject" class="control-label">Tên môn học</label>
			...
			$.ajax({
				...
				success: function(resp) {
					if (resp == 1) {
						...
						$('#msg').html('<div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> Mã môn học đã tồn tại.</div>')
						end_load()
					}
				}
			})
